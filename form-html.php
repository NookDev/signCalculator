...
<section id="sign-demo">
	...
	<div>
		...
		<input type="radio" name="distribution" value="space-evenly"><span>&nbspSpace-Evenly</span>
...
<section id="order-options">
	...
	<div class="input-container">
		...
		<div class="warning">WARNING - Cannot submit, line 3 exceeds sign's padding.</div>
